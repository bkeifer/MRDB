...
class CarForm(forms.ModelForm):
    ...
    class Meta:
        model = Car
        fields = ('railroad', 'number', 'type', 'length', 'livery', 'coupler', 'manufacturer', 'year', 'modelnumber', 'stocktype')
...
class LocomotiveForm(forms.ModelForm):
    ...
    class Meta:
        model = Locomotive
        fields = ('railroad', 'manufacturer', 'number', 'address', 'livery', 'coupler', 'length', 'power', 'stocktype', 'year', 'modelnumber', 'make', 'model', 'power', 'axles')
